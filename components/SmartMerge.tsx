      ...
      {showSettings && (
        <div className="border-b bg-blue-50 p-4">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-sm font-semibold text-gray-800 mb-3">Merge Rules & Presets</h3>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                {showAutoHandled ? <EyeOff className="w-4 h-4 inline mr-1" /> : <Eye className="w-4 h-4 inline mr-1" />}
                {showAutoHandled ? 'Hide' : 'Show'} Auto-handled Changes
              </button>
            </div>
          </div>
        </div>
